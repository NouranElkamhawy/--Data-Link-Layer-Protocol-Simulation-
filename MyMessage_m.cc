...
//******************************************************************
void MyMessage_Base::setSendingTime(double time)
{
    this->sending_time = time;
}
double MyMessage_Base::getSendingTime()
{
    return this->sending_time;
}
void MyMessage_Base::setAckID(int ack_id)
{
    this->AckID = ack_id;
}
int MyMessage_Base::getAckID()
{
    return this->AckID;
}
//*******************************************************************
...
vector<bitset<1>> MyMessage_Base::getMyHammingCode()
{
    return this->hamming_code;
}

void MyMessage_Base::setMyHammingCode(const vector<bitset<1>> hamming_code)
{
    this->hamming_code = hamming_code;
}
